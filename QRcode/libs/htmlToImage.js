!(function (t, e) {
	...
	function s(t, e) {
		...
		var n,
			...
			o =
				e.width ||
				((r = a((n = t), 'border-left-width')),
				(i = a(n, 'border-right-width')),
				n.clientWidth + r + i),
			u =
				e.height ||
				(function (t) {
				...
				switch (n.label) {
					...
					case 1:
						if (404 === (e = n.sent()).status)
							throw new Error('Resource "'.concat(e.url, '" not found'));
						return [4, e.blob()];
					case 2:
						return (
							(o = n.sent()),
				...
				switch (n.label) {
					case 0:
						if (
							...
							return [2, P[e]];
						i.cacheBust && (t += (/\?/.test(t) ? '&' : '?') + new Date().getTime()),
							(n.label = 1);
					case 1:
						return (
							n.trys.push([1, 3, , 4]),
				...
				switch (e.label) {
					case 0:
						return (
							e.trys.push([0, 3, , 4]),
							(
								null === (i = null == t ? void 0 : t.contentDocument) ||
								void 0 === i
									? void 0
									: i.body
							)
		...
		return e(this, void 0, void 0, function () {
			...
			return n(this, function (n) {
				switch (n.label) {
					case 0:
						return (e =
							null === (o = r.style) || void 0 === o ? void 0 : o.getPropertyValue(t))
							? [4, q(e, null, i)]
							: [3, 2];
					case 1:
						return (
							(u = n.sent()),
							r.style.setProperty(t, u, r.style.getPropertyPriority(t)),
							[2, !0]
						);
					case 2:
						return [2, !1];
				...
				return (
					...
					(c = u.map(function (u) {
						return e(a, void 0, void 0, function () {
							...
							return n(this, function (n) {
								return (
									(e = u.replace(o, '$1')).startsWith('https://') ||
									...
									[
										...
										C(e, r.fetchRequestInit, function (t) {
											var e = t.result;
											return (
												(i = i.replace(u, 'url('.concat(e, ')'))), [u, e]
											);
										}),
									]
								);
							...
							return (
								...
								(f =
									...
									(function () {
										...
										return (
											n &&
												((t = parseInt(n, 10)), Number.isNaN(t) && (t = 1)),
					...
					return n(this, function (n) {
						switch (n.label) {
							...
							case 1:
								return (
									(u = n.sent()),
									[2, u.getContext('2d').getImageData(0, 0, i, o).data]
								);
						}
					});
				})
